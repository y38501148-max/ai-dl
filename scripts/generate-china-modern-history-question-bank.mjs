...
const MANUAL_DISTRACTORS = new Map([
  ...
  ['1949年4月21日，毛泽东和朱德发布《____》。', ['中国人民解放军宣言', '论人民民主专政', '将革命进行到底']],
  ...
  ['第一次火烧圆明园的侵略军是____。', ['英国侵略军', '日本侵略军', '八国联军']],
  ...
  ['中国共产党领导的多党合作与政治协商制度的基本组织形式是____。', ['全国人民代表大会', '国务院', '中央人民政府']],
  // --- 第四轮修复（4 子代理严格逐题重扫）---
  ['八七会议和遵义会议的相同之处是____。', ['纠正了党内错误路线', '确立了正确领导核心', '具有历史转折意义']],
  ['初期新文化运动的实质是____。', ['反对封建主义的思想启蒙', '资产阶级旧民主主义的思想文化运动', '反封建的思想解放运动']],
  ['中国工人阶级以独立的姿态登上政治舞台是____。', ['五四运动', '五卅运动', '国民革命时期']],
  ['在大革命失败的危急关头，中共八七会议确定总方针是____。', ['清除党内右倾机会主义', '武装夺取政权，建立革命根据地', '开展土地革命']],
  ['标志毛泽东思想初步形成的是____。', ['《星星之火，可以燎原》的发表', '井冈山革命根据地的建立', '中国革命新道路的开辟']],
  ['国共十年对峙时期，中共得到农民的衷心拥护原因是进行了____。', ['打土豪分田地', '减租减息', '废除封建剥削']],
  ['大革命时期的统一战线和抗日民族统一战线____。', ['都以反对帝国主义和封建军阀为目标', '体现了全民族的广泛参与', '都实现了国共两党的合作']],
  ['抗战转入相持阶段是在日本占领____后。', ['南京、上海', '北平、天津', '太原、徐州']],
  ['全国性抗战开始于____。', ['卢沟桥事变', '八一三事变', '华北事变']],
  ['共产党在同顽固派作斗争时应坚持____的原则。', ['又联合又斗争', '以斗争求团结', '独立自主']],
  ['1938年10月，日本侵略军占领了广州、武汉后改变了侵华战略方针，这主要是因为____。', ['日本国内反战情绪高涨', '国际形势发生变化', '太平洋战争即将爆发']],
  ['中国共产党在抗日战争时期实行的土地政策是____。', ['交租交息', '没收地主土地', '实行耕者有其田']],
  ['中国人民抗日战争胜利纪念日是____。', ['8月15日', '7月7日', '12月13日']],
  ['抗战胜利后，中国人民的根本利益是____。', ['和平民主团结', '建立联合政府', '打倒蒋介石']],
  ['1946年，政协闭幕第二天，中共中央发出党内指示“从此中国即走上了和平民主建设的新阶段”，国内问题的解决方式是____。', ['武装斗争', '和平谈判', '成立联合政府']],
  ['1947年6月，中国人民解放军开始实行战略进攻的战略意图是由____。', ['战略防御转入战略进攻', '战略决战', '集中优势兵力各个歼灭敌人']],
  ['解放战争时期，国民党统治区人民民主运动高涨的根本原因是____。', ['国民党政府经济崩溃和政治危机', '国民党专制统治不得人心', '中共地下党的组织和领导']],
  ['1946年5月4日，中共中央发出《五四指示》所决定的土地政策是____。', ['实行减租减息', '没收地主土地', '废除封建剥削']],
  ['中国共产党得到农民衷心拥护原因是进行了____。', ['打土豪分田地', '废除封建剥削制度', '实行耕者有其田']],
  ['1945年年底爆发的一二一运动，昆明学生提出的口号是____。', ['抗议美军暴行', '要饭吃要和平要自由', '反饥饿反内战反迫害']],
  ['对解放战争时期反蒋斗争第二条战线的准确描述是____。', ['国民党统治区的爱国民主运动', '民主党派的反蒋斗争', '学生运动']],
  ['解放战争时期，中间路线鼓吹者所主张的道路实质上是____。', ['第三条道路', '资产阶级共和国道路', '改良主义道路']],
  ['标志着民盟站在新民主主义革命的立场上来的会议是____。', ['民盟一届二中全会', '各民主党派联合会议', '中间路线座谈会']],
  ['中国各民主党派地位根本变化的标志是____。', ['公开宣布接受中共领导', '响应五一口号', '宣布与国民党决裂']],
  ['1949年，人民解放军占领了南京，宣告延续了22年之久的____覆灭了。', ['国民党南京政权', '国民党专制统治', '大地主大资产阶级专政']],
  ['中华人民共和国成立时，《共同纲领》起____作用。', ['建国纲领', '国家根本法', '临时施政方针']],
  ['巩固和扩大统一战线的关键是坚持____的领导权。', ['无产阶级及其政党', '工农联盟', '中国共产党']],
  ['中国的武装战争实质是由工人阶级领导的____。', ['人民战争', '民族解放战争', '反帝反封建的武装斗争']],
  ['加强中国共产党的建设，首先着重____。', ['党的组织建设', '党的作风建设', '党的政治建设']],
  ['革命的根本问题是____问题。', ['军队', '政权', '武装斗争']],
  ['1947年，刘邓大军挺进中原的重大意义在于____。', ['改变了解放战争的战略态势', '威胁国民党统治核心区', '扭转了全国战局']],
])
...
function parseDocQuestions() {
  ...
  // .doc OCR 修正：修复原始 .doc 文件中常见的 OCR 错误。
  const OCR_CORRECTIONS = {
    '新民主主义各们的开端': '新民主主义革命的开端',
    '陈独秀对妥协退让': '陈独秀的妥协退让',
  }
  for (const question of questions) {
    for (const option of question.options) {
      for (const [wrong, correct] of Object.entries(OCR_CORRECTIONS)) {
        if (option.text.includes(wrong)) option.text = option.text.replace(wrong, correct)
      }
    }
    if (question.explanation) {
      for (const [wrong, correct] of Object.entries(OCR_CORRECTIONS)) {
        if (question.explanation.includes(wrong)) question.explanation = question.explanation.replace(wrong, correct)
      }
    }
  }
...
function extractDocxDrafts(line, chapter) {
  ...
  const exactRules = [
    ...
    ['抗日民族统一战线形成的标志是国民党中央通讯社播发《中国共产党为公布国共合作宣言》', '抗日民族统一战线形成的标志是国民党中央通讯社播发____。', '《中国共产党为公布国共合作宣言》'],
    ...
    ['1949年4月21日，毛泽东和朱德桓发布《向全国进军的命令》', '1949年4月21日，毛泽东和朱德发布《____》。', '向全国进军的命令'],
