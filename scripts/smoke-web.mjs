...
if (manifest.bankTag !== 'multi-0.2.4.1-cmh-audit-20260625-fix3') throw new Error(`题库标记异常：${manifest.bankTag}`)
...
if (cmhManifest.bankTag !== 'cmh-0.1.1-shigang-audit-20260625-fix3') throw new Error(`中国近现代史纲要题库标记异常：${cmhManifest.bankTag}`)
