...
if (iscManifest.bankTag !== 'isc-0.1.7.2-zg120-notice-20260608') throw new Error(`智能感知与控制题库标记异常：${iscManifest.bankTag}`)
if (!iscManifest.releaseNotes?.some((note) => note.includes('修复了一些已知问题'))) throw new Error('智能感知与控制更新说明缺失')
